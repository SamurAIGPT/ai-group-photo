export const standaloneConfig = {
  appId: "cmq6eusko000adsu46hyu8pec",
  name: "ai-group-photo",
  templateId: "ai-image",
  config: {
  ...
  "userParams": [
    {
      ...
      "label": "Prompt",
      "type": "textarea",
      "defaultValue": "A happy group photo of the person in different outfits and settings standing together smiling, cinematic lighting, realistic, high detailed",
      "options": [],
      "optionsText": "",
      "min": 0,
      "max": 100,
    ...
    },
    {
      ...
      "optionsText": "1:1, 3:4, 4:3, 9:16, 16:9, 21:9",
      "min": 0,
      "max": 100,
      "step": 1,
      "maxInputs": 1
